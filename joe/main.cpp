...
void menu_view() {
    ...
    Button about_button(getwidth() / 2 - four_text_w / 2, getheight() / 2 - default_height / 2 + 4 * default_height,
        four_text_w, default_height, "关于", BROWN);
    Button over_button(getwidth() / 2 - four_text_w / 2, getheight() / 2 - default_height / 2 + 5 * default_height,
    ...
    while (flag == MY_MENU)
    {
        ...
        if (!about_button.touch_button(YELLOW)) {
            about_button.show_button(BROWN);
        }
        ...
        else if (about_button.click_button()) {
            flag = MY_ABOUT;
        }
...
void about_view() {
    Button return_button(1000, 50, 100, 50, "返回", BROWN);
    setbkcolor(RGB(191, 187, 177));
    BeginBatchDraw();
    loadimage(&img, "../resources/成员介绍.jpg");
    while (flag == MY_ABOUT)
    {
        cleardevice();
        putimage(0, 0, &img);
...
void pause_view() {
    ...
    Button help_button(getwidth() / 2 - four_text_w / 2, getheight() / 2 - default_height / 2 + 2 * default_height,
        four_text_w, default_height, "帮助", BROWN);
    Button about_button(getwidth() / 2 - four_text_w / 2, getheight() / 2 - default_height / 2 + 3 * default_height,
        four_text_w, default_height, "关于", BROWN);
    Button menu_button(getwidth() / 2 - four_text_w / 2, getheight() / 2 - default_height / 2 + 4 * default_height,
